        ...
        form.addEventListener("submit", async (event) => {
            ...
            if (numItems > 0) {
                ...
                for (let i = 0; i < numItems; i++) {
                    dadosCorretos.push({
                        codigo_propriedade: jsonData.codigo_propriedade[i],
                        ui: jsonData.ui[i],
                        parcela_t: jsonData.parcela_t[i],
                        codigo_ut: jsonData.codigo_ut[i],
                        fiscal_responsavel: jsonData.fiscal_responsavel[i],
                        municipio: jsonData.municipio[i],
                        empresa: jsonData.empresa[i],
                        mes_medicao: jsonData.mes_medicao[i],
                        metodo: jsonData.metodo[i],
