"""
Django settings for fiscalização_brd project.
...
SECRET_KEY = 'django-insecure-k@*n5fj&&-8ygvb_n2)r4y(*10d@$i9g#fg!4#!@3@57015y@n'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['jossanny.pythonanywhere.com', '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'fiscalização_brd.urls'
...
WSGI_APPLICATION = 'fiscalização_brd.wsgi.application'
